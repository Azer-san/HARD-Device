...
os.makeris(s(OUT_DIR, exist_ok=True)
...
y_trainval = np.concatenate([y_trian, y_val])
...
#to test 
print(f"Scaled trainval: {X_trainval_sc.shape}")  # should be (N, 83)
print(f"Scaled test:     {X_test_sc.shape}")       # should be (M, 83)
